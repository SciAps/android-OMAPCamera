...
public class CPCamFaceView extends View implements FocusIndicator, Rotatable {
    private final String TAG = "CPCamFaceView";
    ...
    public CPCamFaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
