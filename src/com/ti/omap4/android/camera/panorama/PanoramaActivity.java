...
package com.ti.omap4.android.camera.panorama;

import com.ti.omap4.android.camera.ActivityBase;
import com.ti.omap4.android.camera.CameraDisabledException;
import com.ti.omap4.android.camera.CameraHardwareException;
import com.ti.omap4.android.camera.CameraHolder;
import com.ti.omap4.android.camera.Exif;
import com.ti.omap4.android.camera.MenuHelper;
import com.ti.omap4.android.camera.ModePicker;
import com.ti.omap4.android.camera.OnClickAttr;
import com.ti.omap4.android.camera.R;
import com.ti.omap4.android.camera.RotateDialogController;
import com.ti.omap4.android.camera.ShutterButton;
...
public class PanoramaActivity extends ActivityBase implements
    ...
    private Uri savePanorama(byte[] jpegData, int width, int height, int orientation) {
        if (jpegData != null) {
            ...
            Uri uri = Storage.addImage(getContentResolver(), filename, "jpg", mTimeTaken, null,
                    orientation, jpegData, width, height);
            if (uri != null && orientation != 0) {
                String filepath = Storage.generateFilepath(filename, "jpg");
                try {
